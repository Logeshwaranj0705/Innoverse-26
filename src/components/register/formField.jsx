...
export default function FormField() {
  ...
  const validateCurrentMember = () => {
    ...
    if (!m?.clgMode) {
      fieldErrors.clg = "Select college option";
    } else if (m.clgMode === "OTHER") {
      const clgMsg = validateField("clg", m?.clg ?? "", m);
      if (clgMsg) fieldErrors.clg = clgMsg;
    } else if (m.clgMode === "SIST") {
      if (satState.filled) fieldErrors.clg = "Slot filled for Sathyabama";
    }
